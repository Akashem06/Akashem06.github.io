...
- TCP/IP
highlights:
- Led end-to-end firmware design for the battery management system
- power distribution
- driver controls
- and telemetry across 2 solar electric vehicles.
...
- Developed battery management system firmware for 288 lithium-ion cells over isolated
  SPI and I2C
- with passive cell balancing holding pack imbalance under 50 mV.
- Secured top 10 finishes at 2 annual competitions
- as the first Canadian single-occupant vehicle team to pass scrutineering
